...
SWITCH_CONTROLLER_INFO = {
    'controller_ip': '60.0.0.2',
    'controller_mac': '02:42:ac:0c:06:00',
    'speaker_ip': '75.0.0.6',
    'speaker_mac': '02:42:ac:0c:06:01',
    'speaker_port': 'eth1'
}
# key: is IP controller (of peering), value: is mac of the interface of OF-switch on peering Lan
INFO_NEIGHBORS = {
    '75.0.0.2': {'mac': '02:42:ac:0f:02:05', 'port': 'eth4', 'as_number': 2},
    '75.0.0.4': {'mac': '02:42:ac:0f:04:04', 'port': 'eth2', 'as_number': 4},
    '75.0.0.7': {'mac': '02:42:ac:0f:07:02', 'port': 'eth3', 'as_number': 7}
}
